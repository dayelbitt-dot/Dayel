          ...
          properties: {
            tipo: {
              ...
              enum: [
                ...
                "abrir_pagina", "abrir_processo", "abrir_cliente", "ligar", "whatsapp",
              ],
            },
            ...
            numero: { type: "string", description: "Nº CNJ do processo (criar_processo)." },
...
const SYSTEM = (hoje: string) => [
  ...
  "MINUTAS E TEXTOS JURÍDICOS: quando pedirem uma minuta (contestação, petição, contrato, e-mail…), redija o texto e proponha 'criar_nota' com titulo = o que é e texto = a minuta completa; explique em 'resposta'. Para procuração e declaração de hipossuficiência prontas para imprimir, indique também a página 'documentos' (abrir_pagina).",
